...
/*
 * Class:     org_dtera_cnt_fl_crypto_heu_HeuJNI
 * Method:    heKitCreate
 * Signature: (II[J)I
 */
JNIEXPORT jint JNICALL Java_org_dtera_cnt_fl_crypto_heu_HeuJNI_heKitCreate(JNIEnv *jenv, jclass,
                                                                           jint jschema,
                                                                           jint jkey_size,
                                                                           jlongArray jout) {
  HeKitHandle handle;
 ...
 * Signature: ([B[B[J)I
 */
JNIEXPORT jint JNICALL Java_org_dtera_cnt_fl_crypto_heu_HeuJNI_heKitCreateFromKeys(
    JNIEnv *jenv, jclass, jbyteArray jpubhandle, jbyteArray jsechandle, jlongArray jout) {
  ...
  HeKitHandle handle;
  int ret = HeKitCreateFromKeys(pub_key_handle, pub_key_len, sec_key_handle, sec_key_len, &handle);
 ...
 * Signature: (J)I
 */
JNIEXPORT jint JNICALL Java_org_dtera_cnt_fl_crypto_heu_HeuJNI_heKitFree(JNIEnv *, jclass,
                                                                         jlong jhandle) {
 ...
 * Signature: ([B[J)I
 */
JNIEXPORT jint JNICALL Java_org_dtera_cnt_fl_crypto_heu_HeuJNI_destinationHeKitCreate(
 ...
 * Signature: (J)I
 */
JNIEXPORT jint JNICALL Java_org_dtera_cnt_fl_crypto_heu_HeuJNI_destinationHeKitFree(JNIEnv *,
                                                                                    jclass,
                                                                                    jlong jhandle) {
 ...
 * Signature: (J[B)I
 */
JNIEXPORT jbyteArray JNICALL Java_org_dtera_cnt_fl_crypto_heu_HeuJNI_getPubKey(JNIEnv *jenv, jclass,
                                                                               jlong jhandle) {
  jbyteArray jout;
 ...
 * Signature: (J)[B
 */
JNIEXPORT jbyteArray JNICALL Java_org_dtera_cnt_fl_crypto_heu_HeuJNI_getSecKey(JNIEnv *jenv, jclass,
                                                                               jlong jhandle) {
  jbyteArray jout;
 ...
 * Signature: (J[D[[B)I
 */
JNIEXPORT jint JNICALL Java_org_dtera_cnt_fl_crypto_heu_HeuJNI_encrypt(JNIEnv *jenv, jclass,
                                                                       jlong jhandle,
 ...
 * Signature: (J[D[D[[B)I
 */
JNIEXPORT jint JNICALL Java_org_dtera_cnt_fl_crypto_heu_HeuJNI_encryptPair(
    JNIEnv *jenv, jclass, jlong jhandle, jdoubleArray jplaintexts1, jdoubleArray jplaintexts2,
    jobjectArray jbas) {
  ...
  heu::lib::phe::Ciphertext ciphers[len];
  auto ret = Encrypt<double>((HeKitHandle)jhandle, plaintexts1, plaintexts2, len, ciphers);
 ...
 * Signature: (J[[B[D)I
 */
JNIEXPORT jint JNICALL Java_org_dtera_cnt_fl_crypto_heu_HeuJNI_decrypt(JNIEnv *jenv, jclass,
                                                                       jlong jhandle,
                                                                       jobjectArray jbas,
                                                                       jdoubleArray jplaintexts) {
 ...
 * Signature: (J[[B[D[D)I
 */
JNIEXPORT jint JNICALL Java_org_dtera_cnt_fl_crypto_heu_HeuJNI_decryptPair(
    JNIEnv *jenv, jclass, jlong jhandle, jobjectArray jbas, jdoubleArray jplaintexts1,
    jdoubleArray jplaintexts2) {
  auto len = jenv->GetArrayLength(jbas);
  heu::lib::phe::Ciphertext ciphers[len];
  jobjectarray_to_ciphers(jenv, jbas, ciphers);
 ...
 * Signature: (JD)[B
 */
JNIEXPORT jbyteArray JNICALL Java_org_dtera_cnt_fl_crypto_heu_HeuJNI_encrypt1(JNIEnv *jenv, jclass,
                                                                              jlong jhandle,
                                                                              jdouble jplaintext) {
  heu::lib::phe::Ciphertext cipher;
  CheckCall(Encrypt<double>((HeKitHandle)jhandle, jplaintext, &cipher), "encrypt1");
 ...
 * Signature: (JDD)[B
 */
JNIEXPORT jbyteArray JNICALL Java_org_dtera_cnt_fl_crypto_heu_HeuJNI_encryptPair1(
    JNIEnv *jenv, jclass, jlong jhandle, jdouble jplaintext1, jdouble jplaintext2) {
  heu::lib::phe::Ciphertext cipher;
  CheckCall(Encrypt<double>((HeKitHandle)jhandle, jplaintext1, jplaintext2, &cipher),
            "encryptPair1");
  return cipher_to_jbytes(jenv, cipher);
}
 ...
 * Signature: (J[B)D
 */
JNIEXPORT jdouble JNICALL Java_org_dtera_cnt_fl_crypto_heu_HeuJNI_decrypt1(JNIEnv *jenv, jclass,
                                                                           jlong jhandle,
                                                                           jbyteArray jba) {
  heu::lib::phe::Ciphertext cipher;
 ...
 * Signature: (J[B[D)I
 */
JNIEXPORT jint JNICALL Java_org_dtera_cnt_fl_crypto_heu_HeuJNI_decryptPair1(JNIEnv *jenv, jclass,
                                                                            jlong jhandle,
                                                                            jbyteArray jba,
                                                                            jdoubleArray jout) {
  heu::lib::phe::Ciphertext cipher;
 ...
 * Signature: (J[D[[B)I
 */
JNIEXPORT jint JNICALL Java_org_dtera_cnt_fl_crypto_heu_HeuJNI_dhekitEncrypt(
    JNIEnv *jenv, jclass, jlong jhandle, jdoubleArray jplaintexts, jobjectArray jbas) {
  auto *plaintexts = jenv->GetDoubleArrayElements(jplaintexts, 0);
  auto len = jenv->GetArrayLength(jplaintexts);
  heu::lib::phe::Ciphertext ciphers[len];
  auto ret =
      DestinationHeKitEncrypt<double>((DestinationHeKitHandle)jhandle, plaintexts, len, ciphers);
  jenv->ReleaseDoubleArrayElements(jplaintexts, plaintexts, 0);
  ciphers_to_jobjectarray(jenv, ciphers, jbas);
  return ret;
}
 ...
 * Signature: (J[D[D[[B)I
 */
JNIEXPORT jint JNICALL Java_org_dtera_cnt_fl_crypto_heu_HeuJNI_dhekitEncryptPair(
    JNIEnv *jenv, jclass, jlong jhandle, jdoubleArray jplaintexts1, jdoubleArray jplaintexts2,
    jobjectArray jbas) {
  auto *plaintexts1 = jenv->GetDoubleArrayElements(jplaintexts1, 0);
  auto *plaintexts2 = jenv->GetDoubleArrayElements(jplaintexts2, 0);
  auto len = jenv->GetArrayLength(jplaintexts1);
  heu::lib::phe::Ciphertext ciphers[len];
  auto ret = DestinationHeKitEncrypt<double>((DestinationHeKitHandle)jhandle, plaintexts1,
                                             plaintexts2, len, ciphers);
  jenv->ReleaseDoubleArrayElements(jplaintexts1, plaintexts1, 0);
  jenv->ReleaseDoubleArrayElements(jplaintexts2, plaintexts2, 0);
  ciphers_to_jobjectarray(jenv, ciphers, jbas);
  return ret;
 ...
 * Signature: (JD)[B
 */
JNIEXPORT jbyteArray JNICALL Java_org_dtera_cnt_fl_crypto_heu_HeuJNI_dhekitEncrypt1(
    JNIEnv *jenv, jclass, jlong jhandle, jdouble jplaintext) {
  heu::lib::phe::Ciphertext cipher;
  CheckCall(DestinationHeKitEncrypt<double>((DestinationHeKitHandle)jhandle, jplaintext, &cipher),
            "dhekitEncrypt1");
  return cipher_to_jbytes(jenv, cipher);
}
 ...
 * Signature: (JDD)[B
 */
JNIEXPORT jbyteArray JNICALL Java_org_dtera_cnt_fl_crypto_heu_HeuJNI_dhekitEncryptPair1(
    JNIEnv *jenv, jclass, jlong jhandle, jdouble jplaintext1, jdouble jplaintext2) {
  heu::lib::phe::Ciphertext cipher;
  CheckCall(DestinationHeKitEncrypt<double>((DestinationHeKitHandle)jhandle, jplaintext1,
                                            jplaintext2, &cipher),
            "dhekitEncryptPair1");
  return cipher_to_jbytes(jenv, cipher);
}
 ...
 */
JNIEXPORT
jbyteArray JNICALL Java_org_dtera_cnt_fl_crypto_heu_HeuJNI_addCipher(JNIEnv *jenv, jclass,
                                                                     jlong jdhandle,
                                                                     jbyteArray jba1,
                                                                     jbyteArray jba2) {
 ...
 * Signature: (J[B[B)[B
 */
JNIEXPORT jbyteArray JNICALL Java_org_dtera_cnt_fl_crypto_heu_HeuJNI_addCipherInplace(
    JNIEnv *jenv, jclass, jlong jdhandle, jbyteArray jba1, jbyteArray jba2) {
  heu::lib::phe::Ciphertext c1, c2;
  jbytes_to_cipher(jenv, jba1, c1);
  jbytes_to_cipher(jenv, jba2, c2);
  CheckCall(AddCipherInplace((DestinationHeKitHandle)jdhandle, c1, c2), "addCipherInplace");
 ...
 * Signature: (J[[B[[B)[[B
 */
JNIEXPORT jint JNICALL Java_org_dtera_cnt_fl_crypto_heu_HeuJNI_addCiphersInplace(
    JNIEnv *jenv, jclass, jlong jdhandle, jobjectArray jciphers1, jobjectArray jciphers2) {
 ...
 * Signature: (J[[B[[B[J)I
 */
JNIEXPORT jint JNICALL Java_org_dtera_cnt_fl_crypto_heu_HeuJNI_scatterAddCiphersInplace(
    JNIEnv *jenv, jclass, jlong jdhandle, jobjectArray jciphers1, jobjectArray jciphers2,
    jlongArray jindexes, jboolean parallel) {
 ...
 * Signature: (J[[B[[[B)I
 */
JNIEXPORT jint JNICALL Java_org_dtera_cnt_fl_crypto_heu_HeuJNI_addCiphersInplaceAxis0(
    JNIEnv *jenv, jclass, jlong jdhandle, jobjectArray jciphers1, jobjectArray jciphers2) {
  ...
  auto ret = AddCiphersInplaceAxis0_((DestinationHeKitHandle)jdhandle, cs1, cs2, row_size, len);
 ...
 * Signature: (J[B[B)[B
 */
JNIEXPORT jbyteArray JNICALL Java_org_dtera_cnt_fl_crypto_heu_HeuJNI_subCipher(JNIEnv *jenv, jclass,
                                                                               jlong jdhandle,
                                                                               jbyteArray jba1,
                                                                               jbyteArray jba2) {
  heu::lib::phe::Ciphertext c1, c2;
 ...
 * Signature: (J[B[B)[B
 */
JNIEXPORT jbyteArray JNICALL Java_org_dtera_cnt_fl_crypto_heu_HeuJNI_subCipherInplace(
    JNIEnv *jenv, jclass, jlong jdhandle, jbyteArray jba1, jbyteArray jba2) {
  heu::lib::phe::Ciphertext c1, c2;
  jbytes_to_cipher(jenv, jba1, c1);
  jbytes_to_cipher(jenv, jba2, c2);
  CheckCall(SubCipherInplace((DestinationHeKitHandle)jdhandle, c1, c2), "subCipherInplace");
  return cipher_to_jbytes(jenv, c1);
}
 ...
 * Signature: (J[[B[[B)I
 */
JNIEXPORT jint JNICALL Java_org_dtera_cnt_fl_crypto_heu_HeuJNI_subCiphersInplace(
    JNIEnv *jenv, jclass, jlong jdhandle, jobjectArray jciphers1, jobjectArray jciphers2) {
  auto len = jenv->GetArrayLength(jciphers1);
  heu::lib::phe::Ciphertext cs1[len], cs2[len];
  jobjectarray_to_cipher_pairs(jenv, jciphers1, jciphers2, cs1, cs2);
 ...
 * Signature: (J[[B[[B[J)I
 */
JNIEXPORT jint JNICALL Java_org_dtera_cnt_fl_crypto_heu_HeuJNI_scatterSubCiphersInplace(
    JNIEnv *jenv, jclass, jlong jdhandle, jobjectArray jciphers1, jobjectArray jciphers2,
    jlongArray jindexes, jboolean parallel) {
  auto len1 = jenv->GetArrayLength(jciphers1);
  auto len2 = jenv->GetArrayLength(jciphers2);
 ...
 * Signature: (J[[B[[[B)I
 */
JNIEXPORT jint JNICALL Java_org_dtera_cnt_fl_crypto_heu_HeuJNI_subCiphersInplaceAxis0(
    JNIEnv *jenv, jclass, jlong jdhandle, jobjectArray jciphers1, jobjectArray jciphers2) {
  auto len = jenv->GetArrayLength(jciphers2);
  heu::lib::phe::Ciphertext cs1[len];
  heu::lib::phe::Ciphertext **cs2 = new heu::lib::phe::Ciphertext *[len];
  ...
  auto ret = SubCiphersInplaceAxis0_((DestinationHeKitHandle)jdhandle, cs1, cs2, row_size, len);
  ciphers_to_jobjectarray(jenv, cs1, jciphers1, cs2);
  return ret;
}
 ...
 * Signature: (J[BD)[B
 */
JNIEXPORT jbyteArray JNICALL Java_org_dtera_cnt_fl_crypto_heu_HeuJNI_multiPlain(
 ...
 * Signature: (J[BD)[B
 */
JNIEXPORT jbyteArray JNICALL Java_org_dtera_cnt_fl_crypto_heu_HeuJNI_multiPlainInplace(
    JNIEnv *jenv, jclass, jlong jdhandle, jbyteArray jba, jdouble jfactor) {
  heu::lib::phe::Ciphertext c;
  jbytes_to_cipher(jenv, jba, c);
  CheckCall(MultiPlainInplace((DestinationHeKitHandle)jdhandle, c, jfactor), "multiPlainInplace");
  return cipher_to_jbytes(jenv, c);
}
 ...
 * Signature: (J[[BI)[B
 */
JNIEXPORT jbyteArray JNICALL Java_org_dtera_cnt_fl_crypto_heu_HeuJNI_sumCiphers(
    JNIEnv *jenv, jclass, jlong jdhandle, jobjectArray jciphers, jint jminWorkSize) {
  auto len = jenv->GetArrayLength(jciphers);
  heu::lib::phe::Ciphertext ciphers[len];
  jobjectarray_to_ciphers(jenv, jciphers, ciphers);
  heu::lib::phe::Ciphertext out;
  SumCiphers((DestinationHeKitHandle)jdhandle, ciphers, len, &out, jminWorkSize);
