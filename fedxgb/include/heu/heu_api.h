...
#define HE_DECRYPTS(HE_HANDLE)                                                 \
  HE_DECRYPTS_(HE_HANDLE,                                                      \
               data[i] = encoder.Decode<T>(decrypter->Decrypt(ciphers[i]));)
 ...
 */
HEU_DLL int
GetBuffer(HeKitHandle handle, void **out,
 ...
 */
HEU_DLL int
GetPubKey(HeKitHandle handle, PubKeyHandle *out,
          std::function<void(yacl::Buffer &buf)> process_buf = nullptr);
 ...
 */
HEU_DLL int
GetSecKey(HeKitHandle handle, SecKeyHandle *out,
          std::function<void(yacl::Buffer &buf)> process_buf = nullptr);
...
template <typename T,
          typename std::enable_if_t<std::is_arithmetic_v<T>, int> = 0>
[[nodiscard]] int
Encrypt(HeKitHandle handle, T **data1, T **data2, const int len, const int len2,
...
template <typename T,
          typename std::enable_if_t<std::is_arithmetic_v<T>, int> = 0>
[[nodiscard]] int
Decrypt(HeKitHandle handle, heu::lib::phe::Ciphertext *ciphers, const int len,
...
template <typename T,
          typename std::enable_if_t<std::is_arithmetic_v<T>, int> = 0>
[[nodiscard]] int
DestinationHeKitEncrypt(DestinationHeKitHandle handle, T *data, const int len,
                        heu::lib::phe::Ciphertext *ciphers, int64_t scale = 1e6,
                        int32_t n_threads = omp_get_num_procs()) {
...
template <typename T,
          typename std::enable_if_t<std::is_arithmetic_v<T>, int> = 0>
[[nodiscard]] int
DestinationHeKitEncrypt(DestinationHeKitHandle handle, T *data1, T *data2,
...
HEU_DLL int ScatterAddCiphersInplace(DestinationHeKitHandle handle,
                                     heu::lib::phe::Ciphertext *cs1,
                                     const heu::lib::phe::Ciphertext *cs2,
                                     const long *indexes, const int len,
                                     bool parallel = true,
                                     int32_t n_threads = omp_get_num_procs());
 ...
 * \return 0 when success, -1 when failure happens
 */
HEU_DLL int AddCiphersInplaceAxis0(DestinationHeKitHandle handle,
                                   heu::lib::phe::Ciphertext *cs1,
 ...
 * \return 0 when success, -1 when failure happens
 */
HEU_DLL int SubCiphersInplaceAxis0(DestinationHeKitHandle handle,
                                   heu::lib::phe::Ciphertext *cs1,
                                   heu::lib::phe::Ciphertext **cs2,
                                   const int len1, const int len2,
                                   int32_t n_threads = omp_get_num_procs());
 ...
 * \return 0 when success, -1 when failure happens
 */
HEU_DLL int SubCiphersInplaceAxis0_(DestinationHeKitHandle handle,
                                    heu::lib::phe::Ciphertext *cs1,
                                    heu::lib::phe::Ciphertext **cs2,
                                    int *row_size, const int len,
                                    int32_t n_threads = omp_get_num_procs());
 ...
 */
inline heu::lib::phe::Ciphertext
AddCipher(DestinationHeKitHandle handle, const heu::lib::phe::Ciphertext &c1,
          const heu::lib::phe::Ciphertext &c2) {
 ...
 */
inline heu::lib::phe::Ciphertext
SubCipher(DestinationHeKitHandle handle, const heu::lib::phe::Ciphertext &c1,
          const heu::lib::phe::Ciphertext &c2) {
...
template <typename T,
          typename std::enable_if_t<std::is_arithmetic_v<T>, int> = 0>
[[nodiscard]] inline heu::lib::phe::Ciphertext
AddPlain(DestinationHeKitHandle handle, const heu::lib::phe::Ciphertext &c,
...
template <typename T,
          typename std::enable_if_t<std::is_arithmetic_v<T>, int> = 0>
[[nodiscard]] inline heu::lib::phe::Ciphertext
SubPlain(DestinationHeKitHandle handle, const heu::lib::phe::Ciphertext &c,
         const T &p, int64_t scale = 1e6) {
  API_DHEKIT_RET({
...
template <typename T,
          typename std::enable_if_t<std::is_arithmetic_v<T>, int> = 0>
[[nodiscard]] inline heu::lib::phe::Ciphertext
MultiPlain(DestinationHeKitHandle handle, const heu::lib::phe::Ciphertext &c,
