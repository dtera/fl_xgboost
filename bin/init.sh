...
if [ "$os_release" == "manjaro" ]; then
  ...
  yum -y install openssl cmake autoconf libtool pkg-config centos-release-scl devtoolset-7-gcc* \
    openssl tbb tbb-devel boost boost-devel boost-build gtest-devel gmock-devel gmp-devel
fi
# =================================================================================================================
# ==============================================Prepare End========================================================
# =================================================================================================================
...
if [ "$ver" != "1.35.0" ]; then
  ...
  mkdir -p cmake/build && pushd cmake/build || exit
  cmake \
    -DCMAKE_BUILD_TYPE=Release \
    -DgRPC_INSTALL=ON \
...
export LD_LIBRARY_PATH="/usr/local/grpc/lib:/usr/local/grpc/lib64:$LD_LIBRARY_PATH"
export LDFLAGS="-Wl,--copy-dt-needed-entries"
echo "export LD_LIBRARY_PATH=/usr/local/grpc/lib:/usr/local/grpc/lib64:$LD_LIBRARY_PATH" >>~/.bashrc
echo "export LDFLAGS=-Wl,--copy-dt-needed-entries" >>~/.bashrc
# =================================================================================================================
# ==============================================Install gRPC End===================================================
# =================================================================================================================
