 ...
 public:
  ...
  void GetGradient(const HostDeviceVector<bst_float>& preds,
    ...
    common::Transform<>::Init(
        [block_size, ndata, n_targets, pub, pri] XGBOOST_DEVICE(
          ...
          EncryptedGradientPair* encrypted_gpair_ptr = _encrypted_gpair.data();
          ...
          for (size_t idx = begin; idx < end; ++idx) {
            ...
            if (pub != nullptr) {
              // encrypt grad pair
              opt_paillier_encrypt(encrypted_gpair_ptr[idx], out_gpair_ptr[idx], pub, pri);
        ...
        .Eval(&additional_input_, out_gpair, encrypted_gpair, &preds, info.labels.Data(),
              &info.weights_);
